...
VALUES (
  ...
  'ai',
  '不穩定改寫功能 (Unstable Rewrite) 的系統提示詞'
)
ON CONFLICT (key) DO NOTHING;

-- 2. Add 'ai_chaos_verification_prompt' (Irrational Verification)
INSERT INTO public.system_config (key, value, category, description)
VALUES (
  'ai_chaos_verification_prompt',
  to_jsonb('      🧠 B-1 System Prompt（AI 專用）
  ...
  'ai',
  '不理性鑑定功能 (Irrational Verification) 的系統提示詞'
)
ON CONFLICT (key) DO NOTHING;
