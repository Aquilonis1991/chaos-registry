-- DIAGNOSTIC MODE: Disable Permission Check
-- checks are commented out to verifying if the query logic functions correctly.
...
DECLARE
    v_offset INT;
BEGIN
    -- [DEBUG] Permission checks temporarily disabled
