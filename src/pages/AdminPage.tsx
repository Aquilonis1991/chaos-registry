...
import { SocialBotManager } from "@/components/admin/SocialBotManager";
...
const AdminPage = () => {
  ...
  const tabSocialBot = getText('admin.tabs.socialBot', '宣傳機器人');
    ...
    <div className="container mx-auto p-6 max-w-screen-2xl pt-[calc(1.5rem+env(safe-area-inset-top,0px))]">
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
        <TabsList className="grid w-full grid-cols-4 lg:grid-cols-6 xl:grid-cols-12 mb-6 h-auto gap-2">
          ...
          <TabsTrigger value="social-bot">{tabSocialBot}</TabsTrigger>
        </TabsList>
