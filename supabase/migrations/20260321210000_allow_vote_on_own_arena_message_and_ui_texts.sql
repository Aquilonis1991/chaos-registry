...
-- UI texts: Token history 的 arena_shield 文句進入後台 UI 文字管理
INSERT INTO public.ui_texts (key, value, category, description)
VALUES
  ('tokenHistory.type.arenaShield', '購買數據鎖定保險', 'token_history', '失序值使用紀錄：交易類型 arena_shield'),
  ('tokenHistory.description.arenaShield', '購買數據鎖定保險', 'token_history', '失序值使用紀錄：交易描述 arena_shield')
