-- Fix admin user list last-login source mismatch.
-- Use the latest value between profiles.last_login and auth.users.last_sign_in_at.
...
BEGIN
    ...
    WITH filtered_users AS (
        SELECT
            ...
            p.created_at,
            COALESCE(
              GREATEST(p.last_login, u.last_sign_in_at),
              p.last_login,
              u.last_sign_in_at
            ) AS last_login_date,
